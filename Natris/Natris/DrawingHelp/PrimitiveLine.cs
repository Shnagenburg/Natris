...
namespace Natris
{
    ...
    public class PrimitiveLine
    {
        ...
        public static void CreateRectangle(Rectangle myRectangle, Color myColor, SpriteBatch spriteBatch, GraphicsDevice device)
        {
            Color color = Color.White;
            if (myColor != null) color = myColor;
            ...
            PrimitiveLine Topbrush= new PrimitiveLine(device,color);
            Topbrush.AddVector(TopLeft);
            Topbrush.AddVector(TopRight);

            PrimitiveLine Bottombrush = new PrimitiveLine(device, color);
            Bottombrush.AddVector(BottomLeft);
            Bottombrush.AddVector(BottomRight);

            PrimitiveLine Leftbrush = new PrimitiveLine(device, color);
            Leftbrush.AddVector(TopLeft);
            Leftbrush.AddVector(BottomLeft);

            PrimitiveLine Rightbrush = new PrimitiveLine(device, color);
        ...
        public static void CreateFilledRect(Rectangle myRect, Color myColor, SpriteBatch spriteBatch, GraphicsDevice device)
        {
            spriteBatch.Draw(myGame.pixel, myRect, myColor);
        }
    }
}